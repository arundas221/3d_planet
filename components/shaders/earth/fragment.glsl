...
void main() {
    ...
    vec3 specularClaudColor = texture(uSpecularTexture, vUv).rgb;
    ...
    float cloudMix = smoothstep(0.5, 1.0, specularClaudColor.g * 1.1);
    cloudMix = clamp(cloudMix + dayMix * 0.3, 0.0, 1.0);
    ...
    specular *= specularClaudColor.r * 0.7;
